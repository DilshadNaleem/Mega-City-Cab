                ...
                <div class="modal-body">
                    <form action="bookVehicleServlet" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="totalPrice" id="totalPriceInput" readonly>
                        </div>
    ...
    <script>
        document.querySelectorAll('.book-now').forEach(button => {
            button.addEventListener('click', () => {
                const vehicleName = button.getAttribute('data-vehicle');
                ...
                document.getElementById('hiddenRentPerDay').value = rent;
                document.getElementById('totalPriceInput').value = rent;
            });
        });
    </script>
</body>
